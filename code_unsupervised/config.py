...
transforms_A = A.Compose([A.Equalize(), A.Resize(img_size, img_size), A.ToFloat(), ToTensorV2()])

transforms_A2 = A.Compose([A.Resize(img_size, img_size), ToTensorV2()])
